        ...
        <Link key={p.id} to={`/products/${p.id}`} className="flex flex-col bg-other rounded-lg shadow-md overflow-hidden">
          ...
          <div className="p-4 flex flex-col flex-1">
            ...
            <div className="flex items-center justify-between mt-auto pt-2 border-t border-gray-100">
              ...
              <button aria-label="Add to cart" className="bg-primary hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-md transition duration-300 flex items-center gap-2 shrink-0">
