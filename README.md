...
* **ปัญหา/ข้อผิดพลาด (Issue)** — ระบุปัญหาที่พบหากระบบทำงานไม่ถูกต้อง
* **รายละเอียด (Description)** — คำอธิบายเพิ่มเติมเกี่ยวกับข้อผิดพลาดที่พบ

### ขั้นตอนที่ 3: ดำเนินการทดสอบ (Test Cases ตามบทบาทผู้ใช้งาน)

ทดสอบการยอมรับของผู้ใช้งาน (UAT) โดยแบ่งตาม Persona ทั้ง 3 กลุ่ม เพื่อยืนยันว่าฟังก์ชันหลักของระบบทำงานได้ตามที่ออกแบบไว้
